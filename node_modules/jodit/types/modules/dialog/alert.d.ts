 ...
 * ```
 */
export declare const Alert: (msg: string | HTMLElement, title?: string | (() => void | false) | undefined, callback?: string | ((dialog: Dialog) => void | false) | undefined, className?: string) => Dialog;
