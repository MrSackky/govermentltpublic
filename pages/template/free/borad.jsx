      ...
      <Layout >
        ...
        >
          ...
          <div class="md:col-span-12 ">
            <Divider orientation="left"><div class="uppercase tracking-wide text-2xl font-semibold mb-2 "><a href='/template/free/borads'>กระดานข่าว</a> | <span>กระทู้</span></div></Divider>
            <div>
              <span className='text-xl'>Taj Mahal: A breathtaking ode to love</span>
              <div class=" tracking-wide text-sm text-indigo-500 font-semibold">[ 6 ตุลาคม 2564 | Admin ]</div>
