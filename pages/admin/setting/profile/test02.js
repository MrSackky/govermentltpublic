...
export default function Home(props) {
	...
	const fetchOrganizationData = async () => {
		...
		setPreviewImagePerson1('..\\..\\..\\uploads\\c-' + user.organization_id + '\\organization\\' + organizationData.data.organization.person01_image);
		setPreviewVisiblePerson1(true);
		setImageLandingPagePerson1(organizationData.data.organization.o.person01_image);

		setPreviewImagePerson2('..\\..\\..\\uploads\\c-' + user.organization_id + '\\organization\\' + organizationData.data.organization.person02_image);
		setPreviewVisiblePerson2(true);
		setImageLandingPagePerson2(organizationData.data.organization.o.person02_image);

		setPreviewImagePerson3('..\\..\\..\\uploads\\c-' + user.organization_id + '\\organization\\' + organizationData.data.organization.person03_image);
		setPreviewVisiblePerson3(true);
		setImageLandingPagePerson3(organizationData.data.organization.o.person03_image);
		// setPreviewImageLogo('..\\..\\..\\uploads\\c-' + user.organization_id + '\\organization\\' + _organizationData.data.organization.organization_logo);
		// setPreviewVisibleLogo(true);
		// setImageLandingPageLogo(_organizationData.data.organization.organization_logo);
		setFields([
